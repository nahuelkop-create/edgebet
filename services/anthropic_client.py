...
def format_match_prompt(match: dict) -> str:
    ...
    return (
        ...
        "(Mostrá una línea por pick que SÍ entra en la combinada -2 o 3 según corresponda-. Si solo hay 1 pick con cuota real, escribí: - No hay soñada: solo 1 pick con cuota real.)\n\n"
        "👤 PICKS DE JUGADORES:\n"
        ...
        "- 🚀 SOÑADA (formato CRÍTICO): mostrá ÚNICAMENTE los picks que SÍ entran en la combinada, uno por línea. PROHIBIDO mostrar picks descartados, marcar cualquier pick como 'descartado', listar candidatos evaluados, ni escribir anotaciones del tipo '(Solo 2 picks)', '(combinada de 2)' o similares. Si la combinada es de 2 picks, mostrá solo esas 2 líneas más la COMBINADA TOTAL, sin ninguna aclaración extra.\n"
